...
static int _olua_fun_cocos2d_tweenfunc_TweenType___call(lua_State *L)
{
    olua_startinvoke(L);
...
{
    olua_require(L, "cocos2d_action",  luaopen_cocos2d_action);
...
static int _olua_fun_cocos2d_ActionTweenDelegate___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_cc_ActionTweenDelegate(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_cocos2d_ActionTweenDelegate___olua_move);
