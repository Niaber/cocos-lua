...
static int _olua_fun_fairygui_VectorTreeNode___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_fairygui_VectorTreeNode_buffer(lua_State *L)
{
    ...
    // @getter @name(buffer) @type(void *) std::vector<fairygui::GTreeNode *> *buffer()
...
static int _olua_fun_fairygui_VectorTreeNode_value$2(lua_State *L)
{
    ...
    // @setter @name(value) void value(const std::vector<fairygui::GTreeNode *> &v)
    self->value(arg1);
...
static int _olua_cls_fgui_VectorTreeNode(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_VectorTreeNode___olua_move);
...
{
    olua_require(L, "fairygui",  luaopen_fairygui);
...
static int _olua_fun_fairygui_Margin___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_Margin(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_Margin___olua_move);
...
static int _olua_fun_fairygui_HtmlParseOptions___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_HtmlParseOptions(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_HtmlParseOptions___olua_move);
...
static int _olua_fun_fairygui_TweenValue___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_TweenValue(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_TweenValue___olua_move);
...
static int _olua_fun_fairygui_UIEventType___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_UIEventType(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_UIEventType___olua_move);
...
static int _olua_fun_fairygui_EventContext___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_EventContext(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_EventContext___olua_move);
...
static int _olua_fun_fairygui_IHitTest___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_IHitTest(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_IHitTest___olua_move);
...
static int _olua_fun_fairygui_PixelHitTestData___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_fairygui_InputProcessor___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_fairygui_InputEvent___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_InputEvent(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_InputEvent___olua_move);
...
static int _olua_fun_fairygui_TextFormat___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_TextFormat(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_TextFormat___olua_move);
...
static int _olua_fun_fairygui_EaseType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_EaseType(lua_State *L)
{
    ...
    oluacls_func(L, "__call", _olua_fun_fairygui_EaseType___call);
...
static int _olua_fun_fairygui_EaseManager___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_fairygui_TweenPropType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_TweenPropType(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_fairygui_TweenPropType___call);
...
static int _olua_fun_fairygui_GPath___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_GPath(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_GPath___olua_move);
...
static int _olua_fun_fairygui_GTweener_deltaValue(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "fgui.TweenValue"))) {
            // fairygui::TweenValue deltaValue
...
static int _olua_fun_fairygui_GTween___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_GTween(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_GTween___olua_move);
...
static int _olua_fun_fairygui_PackageItem_animation(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "cc.Animation"))) {
            // cocos2d::Animation *animation
...
static int _olua_fun_fairygui_PackageItem_branches(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_pointer(L, 2, "cc.types.VectorString"))) {
            // std::vector<std::string> *branches
...
static int _olua_fun_fairygui_PackageItem_owner(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "fgui.UIPackage"))) {
            // fairygui::UIPackage *owner
...
static int _olua_fun_fairygui_PackageItemType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_PackageItemType(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_fairygui_PackageItemType___call);
...
static int _olua_fun_fairygui_ObjectType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_ObjectType(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_fairygui_ObjectType___call);
...
static int _olua_fun_fairygui_ButtonMode___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_fairygui_ChildrenRenderOrder___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_ChildrenRenderOrder(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_fairygui_ChildrenRenderOrder___call);
...
static int _olua_fun_fairygui_OverflowType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_OverflowType(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_fairygui_OverflowType___call);
...
static int _olua_fun_fairygui_ScrollType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_fairygui_ScrollBarDisplayType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_ScrollBarDisplayType(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_fairygui_ScrollBarDisplayType___call);
...
static int _olua_fun_fairygui_LoaderFillType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_LoaderFillType(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_fairygui_LoaderFillType___call);
...
static int _olua_fun_fairygui_ProgressTitleType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_ProgressTitleType(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_fairygui_ProgressTitleType___call);
...
static int _olua_fun_fairygui_ListLayoutType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_ListLayoutType(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_fairygui_ListLayoutType___call);
...
static int _olua_fun_fairygui_ListSelectionMode___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_ListSelectionMode(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_fairygui_ListSelectionMode___call);
...
static int _olua_fun_fairygui_GroupLayoutType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_GroupLayoutType(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_fairygui_GroupLayoutType___call);
...
static int _olua_fun_fairygui_PopupDirection___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_PopupDirection(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_fairygui_PopupDirection___call);
...
static int _olua_fun_fairygui_AutoSizeType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_AutoSizeType(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_fairygui_AutoSizeType___call);
...
static int _olua_fun_fairygui_FlipType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_fairygui_TransitionActionType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_fairygui_FillMethod___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_fairygui_FillOrigin___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_fairygui_ObjectPropID___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_ObjectPropID(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_fairygui_ObjectPropID___call);
...
static int _olua_fun_fairygui_GList_itemProvider(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_callback(L, 2, "fgui.GList.ListItemProvider") || olua_isnil(L, 2))) {
            // fairygui::GList::ListItemProvider itemProvider
...
static int _olua_fun_fairygui_GList_itemRenderer(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_callback(L, 2, "fgui.GList.ListItemRenderer") || olua_isnil(L, 2))) {
            // fairygui::GList::ListItemRenderer itemRenderer
...
static int _olua_fun_fairygui_Relations___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_Relations(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_Relations___olua_move);
...
static int _olua_fun_fairygui_RelationType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_fairygui_RelationItem___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_RelationItem(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_RelationItem___olua_move);
...
static int _olua_fun_fairygui_UIConfig___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_UIConfig(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_UIConfig___olua_move);
...
static int _olua_fun_fairygui_DragDropManager___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_DragDropManager(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_DragDropManager___olua_move);
...
static int _olua_fun_fairygui_UIObjectFactory___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_UIObjectFactory(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_UIObjectFactory___olua_move);
...
static int _olua_fun_fairygui_GearBase___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_fgui_GearBase(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_GearBase___olua_move);
...
static int _olua_fun_fairygui_GTree_treeNodeRender(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_callback(L, 2, "fgui.GTree.TreeNodeRenderFunction") || olua_isnil(L, 2))) {
            // fairygui::GTree::TreeNodeRenderFunction treeNodeRender
...
static int _olua_fun_fairygui_GTree_treeNodeWillExpand(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_callback(L, 2, "fgui.GTree.TreeNodeWillExpandFunction") || olua_isnil(L, 2))) {
            // fairygui::GTree::TreeNodeWillExpandFunction treeNodeWillExpand
...
static int _olua_fun_fairygui_HtmlObject___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_fairygui_HtmlElement_Type___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_fairygui_HtmlElement___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_fairygui_HtmlElement_format(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "fgui.TextFormat"))) {
            // fairygui::TextFormat format
...
static int _olua_fun_fairygui_HtmlElement_link(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "fgui.HtmlElement"))) {
            // fairygui::HtmlElement *link
...
static int _olua_fun_fairygui_HtmlElement_obj(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "fgui.HtmlObject"))) {
            // fairygui::HtmlObject *obj
...
static int _olua_cls_fgui_HtmlElement(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_fairygui_HtmlElement___olua_move);
