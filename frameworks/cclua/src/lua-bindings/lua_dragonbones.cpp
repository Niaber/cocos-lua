...
static int _olua_fun_dragonBones_Rectangle___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_db_Rectangle(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_dragonBones_Rectangle___olua_move);
...
{
    olua_require(L, "dragonbones",  luaopen_dragonbones);
...
static int _olua_fun_dragonBones_BinaryOffset___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_dragonBones_ArmatureType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_dragonBones_OffsetMode___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_dragonBones_DisplayType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_db_DisplayType(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_dragonBones_DisplayType___call);
...
static int _olua_fun_dragonBones_BoundingBoxType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_db_BoundingBoxType(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_dragonBones_BoundingBoxType___call);
...
static int _olua_fun_dragonBones_ActionType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_dragonBones_BlendMode___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_db_BlendMode(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_dragonBones_BlendMode___call);
...
static int _olua_fun_dragonBones_TweenType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_db_TweenType(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_dragonBones_TweenType___call);
...
static int _olua_fun_dragonBones_TimelineType___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_db_TimelineType(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_dragonBones_TimelineType___call);
...
static int _olua_fun_dragonBones_AnimationFadeOutMode___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_dragonBones_TextureFormat___call(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_db_TextureFormat(lua_State *L)
{
    ...
    oluacls_func(L, "__index", olua_indexerror);
    oluacls_func(L, "__newindex", olua_newindexerror);
    oluacls_func(L, "__call", _olua_fun_dragonBones_TextureFormat___call);
...
static int _olua_fun_dragonBones_DragonBones___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_db_DragonBones(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_dragonBones_DragonBones___olua_move);
...
static int _olua_fun_dragonBones_BaseObject___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_db_BaseObject(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_dragonBones_BaseObject___olua_move);
...
static int _olua_fun_dragonBones_EventObject_actionData(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "db.ActionData"))) {
            // const dragonBones::ActionData *actionData
...
static int _olua_fun_dragonBones_EventObject_animationState(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "db.AnimationState"))) {
            // dragonBones::AnimationState *animationState
...
static int _olua_fun_dragonBones_EventObject_armature(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "db.Armature"))) {
            // dragonBones::Armature *armature
...
static int _olua_fun_dragonBones_EventObject_data(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "db.UserData"))) {
            // dragonBones::UserData *data
...
static int _olua_fun_dragonBones_Point___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_db_Point(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_dragonBones_Point___olua_move);
...
static int _olua_fun_dragonBones_ConstraintData_bone(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "db.BoneData"))) {
            // const dragonBones::BoneData *bone
...
static int _olua_fun_dragonBones_IAnimatable___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_dragonBones_DisplayData_parent(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "db.SkinData"))) {
            // dragonBones::SkinData *parent
...
static int _olua_fun_dragonBones_ActionData_slot(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "db.SlotData"))) {
            // const dragonBones::SlotData *slot
...
static int _olua_fun_dragonBones_BoundingBoxDisplayData_boundingBox(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "db.BoundingBoxData"))) {
            // dragonBones::BoundingBoxData *boundingBox
...
static int _olua_fun_dragonBones_CanvasData_aabb(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "db.Rectangle"))) {
            // dragonBones::Rectangle aabb
...
static int _olua_fun_dragonBones_ArmatureData_canvas(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "db.CanvasData"))) {
            // dragonBones::CanvasData *canvas
...
static int _olua_fun_dragonBones_ArmatureData_defaultAnimation(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "db.AnimationData"))) {
            // dragonBones::AnimationData *defaultAnimation
...
static int _olua_fun_dragonBones_SkinData_parent(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "db.ArmatureData"))) {
            // dragonBones::ArmatureData *parent
...
static int _olua_fun_dragonBones_AnimationData_actionTimeline(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_object(L, 2, "db.TimelineData"))) {
            // dragonBones::TimelineData *actionTimeline
...
static int _olua_fun_dragonBones_DragonBonesData_frameArray(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_pointer(L, 2, "olua.int16"))) {
            // const int16_t *frameArray
...
static int _olua_fun_dragonBones_DragonBonesData_timelineArray(lua_State *L)
{
    ...
    if (num_args == 1) {
        // if ((olua_is_pointer(L, 2, "olua.uint16"))) {
            // const uint16_t *timelineArray
...
static int _olua_fun_dragonBones_BaseFactory___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_fun_dragonBones_BaseFactory_changeSkin(lua_State *L)
{
    ...
    if (num_args == 3) {
        // if ((olua_is_object(L, 2, "db.Armature")) && (olua_is_object(L, 3, "db.SkinData")) && (olua_is_pointer(L, 4, "cc.types.VectorString"))) {
            // bool changeSkin(dragonBones::Armature *armature, dragonBones::SkinData *skin, @optional const std::vector<std::string> *exclude)
...
static int _olua_fun_dragonBones_BaseFactory_replaceSkin(lua_State *L)
{
    ...
    if (num_args == 4) {
        // if ((olua_is_object(L, 2, "db.Armature")) && (olua_is_object(L, 3, "db.SkinData")) && (olua_is_bool(L, 4)) && (olua_is_pointer(L, 5, "cc.types.VectorString"))) {
            // bool replaceSkin(dragonBones::Armature *armature, dragonBones::SkinData *skin, @optional bool isOverride, @optional const std::vector<std::string> *exclude)
...
static int _olua_cls_db_BaseFactory(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_dragonBones_BaseFactory___olua_move);
...
static int _olua_fun_dragonBones_IEventDispatcher___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_db_IEventDispatcher(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_dragonBones_IEventDispatcher___olua_move);
