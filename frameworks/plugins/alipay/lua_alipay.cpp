...
static int _olua_fun_cclua_plugin_alipay___olua_move(lua_State *L)
{
    olua_startinvoke(L);
...
static int _olua_cls_cclua_plugin_alipay(lua_State *L)
{
    ...
    oluacls_func(L, "__olua_move", _olua_fun_cclua_plugin_alipay___olua_move);
...
{
    olua_require(L, "alipay",  luaopen_alipay);
